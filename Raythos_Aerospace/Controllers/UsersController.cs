...
namespace Raythos_Aerospace.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(Raythos_AerospaceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Users != null ? 
                          ...
                          Problem("Entity set 'Raythos_AerospaceContext.Users'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Raythos_AerospaceContext.Users'  is null.");
            }
            var users = await _context.Users.FindAsync(id);
            if (users != null)
            {
