...
namespace Raythos_Aerospace.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(Raythos_AerospaceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserRole != null ? 
                          ...
                          Problem("Entity set 'Raythos_AerospaceContext.UserRole'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Password")] UserRole userRole)
        {
            if (id != userRole.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Raythos_AerospaceContext.UserRole'  is null.");
            }
            var userRole = await _context.UserRole.FindAsync(id);
            if (userRole != null)
            {
